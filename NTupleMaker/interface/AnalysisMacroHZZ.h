...
*/
  ...
  T->Branch("isTauFilterNameMatch1", &isTauFilterNameMatch1, "isTauFilterNameMatch1/I");
  T->Branch("isTauFilterNameMatch2", &isTauFilterNameMatch2, "isTauFilterNameMatch2/I");
  T->Branch("singleMuonMatch", &singleMuonMatch, "singleMuonMatch/I");
