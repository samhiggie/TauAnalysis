 ...
 * class:   AnalysisMacroHZZmumuXX.cpp
 * description: Computes the type1 corrections to the luminosity
 * authors: Alexis Kalogerpolous and Sam Higginbotham (shigginb@cern.ch)
 * Notes:
...
///////////search for 2nd tau
	...
	//this tau must pass MVA early too
   		if ( analysisTree.tau_againstElectronVLooseMVA6[tIndex1]<0.5 ||   analysisTree.tau_againstMuonTight3[tIndex1]<0.5) continue;
	...
	//this tau must pass MVA early too
	  if (analysisTree.tau_againstElectronVLooseMVA6[tIndex2]<0.5 ||   analysisTree.tau_againstMuonTight3[tIndex2]<0.5 ) continue;
	...
	if (isTauPair){
//include in the loop.... otherwise missing events
//   if ( analysisTree.tau_againstElectronVLooseMVA6[tau_index_1]<0.5 ||   analysisTree.tau_againstMuonTight3[tau_index_1]<0.5 ||
//	analysisTree.tau_againstElectronVLooseMVA6[tau_index_2]<0.5 ||   analysisTree.tau_againstMuonTight3[tau_index_2]<0.5 ) continue;
	...
	//move this to loop as well
	//
	if (isoTau1 <0.5 || isoTau2 < 0.5) continue;
	}
...
//////////////////////////////////////////////////////
//Looping over 3ltau 3rd muon
//criteria:https://twiki.cern.ch/twiki/bin/viewauth/CMS/HiggsToTauTauWorking2016#Third_lepton_vetoes
//
...
//if not tau index size, don't do this 
   ...
   //isoTau = analysisTree.tau_chargedIsoPtSum[tIndex];
	...
	if (tau_indexMu>-1 && mu_index_3 >-1) isMuonAndTau = true;
      ...
      ptTau = 0;
//////////////////////////////////////////////////////
//Looping over 3ltau 3rd electron
//criteria:https://twiki.cern.ch/twiki/bin/viewauth/CMS/HiggsToTauTauWorking2016#Third_lepton_vetoes
//
